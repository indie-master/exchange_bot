...
## Docker
Чтобы запускать бота в изолированном окружении, соберите образ и передайте учётные данные
через переменные окружения (или используйте `.env`):
...
# либо используйте готовый .env файл
